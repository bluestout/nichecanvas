...
BCSfFilter.prototype.buildProductGridItem = function(e) {
    ...
    var _ = "";
    e.tags && (e.tags.indexOf("limited") > -1 && (_ += '<li class="limtedAdd">Limited Edition</li>'), e.tags.indexOf("onsale") > -1 && (_ += '<li class="gbSale">SALE</li>'), e.tags.indexOf("newarrival") > -1 && (_ += '<li class="gbNewarrive"><img src="https://cdn.shopify.com/s/files/1/2012/8501/t/103/assets/icon-new-arrival.svg" alt="img" title="img">New Arrival</li>'), e.tags.indexOf("trending") > -1 && (_ += '<li class="gbtrmding">Trending</li>'), e.tags.indexOf("featuredartist") > -1 && (_ += '<li class="gbFA"><img src="https://cdn.shopify.com/s/files/1/2012/8501/t/103/assets/icon-featured-artist.svg" alt="img" title="img">Featured Artist</li>'), e.tags.indexOf("bestseller") > -1 && (_ += '<li class="gbBS"><img src="https://cdn.shopify.com/s/files/1/2012/8501/t/103/assets/icon-best-seller.svg" alt="img" title="img">Best Seller</li>')), c = c.replace(/{{itemTags}}/g, _);
